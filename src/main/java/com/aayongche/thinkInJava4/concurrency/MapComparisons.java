package com.aayongche.thinkInJava4.concurrency;//: concurrency/MapComparisons.java
// {Args: 1 10 10} (Fast verification check during build)
// Rough comparison of thread-safe Map performance.
import java.util.concurrent.*;
import java.util.*;

import com.aayongche.thinkInJava4.net.mindview.util.CountingGenerator;
import com.aayongche.thinkInJava4.net.mindview.util.MapData;
