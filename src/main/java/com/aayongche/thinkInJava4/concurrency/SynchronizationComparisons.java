package com.aayongche.thinkInJava4.concurrency;//: concurrency/SynchronizationComparisons.java
...
import static com.aayongche.thinkInJava4.net.mindview.util.Print.printf;
