package com.aayongche.thinkInJava4.generics;//: generics/WatercolorSets.java
import com.aayongche.thinkInJava4.generics.watercolors.Watercolors;
import java.util.*;
import static com.aayongche.thinkInJava4.net.mindview.util.Print.*;
import static com.aayongche.thinkInJava4.net.mindview.util.Sets.*;
import static com.aayongche.thinkInJava4.generics.watercolors.Watercolors.*;
